...
;(function($) {
    ...
    $.fn.vrijLoon.tarieven['2018'] = tarief = $.extend( {}, $.fn.vrijLoon.basisTarief, {
        kalenderJaar: 2018,
        aowLeeftijd: [65, 9],
        ...
        // https://www.rijksoverheid.nl/onderwerpen/minimumloon/inhoud/bedragen-minimumloon-2018
        minimum: {
            1: {
                21: { dag: 72.83, week: 364.15, maand: 1578.00 },
            }
        },
        ...
        box1: {
            niet: [
                { naam: 'Schijf 1', bovenGrens: 19982, percentage: 36.55 },
                { naam: 'Schijf 2', bovenGrens: 33791, percentage: 40.8 },
                { naam: 'Schijf 3', bovenGrens: 67072, percentage: 40.8 },
                { naam: 'Schijf 4', percentage: 52 },
            ],
            in: [], // TODO?
            voor: [
                { naam: 'Schijf 1', bovenGrens: 19982, percentage: 18.65 },
                { naam: 'Schijf 2', bovenGrens: 33791, percentage: 22.9 },
                { naam: 'Schijf 3', bovenGrens: 67072, percentage: 40.8 },
                { naam: 'Schijf 4', percentage: 52 },
            ],
        },
        ...
        heffingsKorting: {
            niet: [
                { bovenGrens: 20142, bedrag: 2265 },
                { bovenGrens: 68507, bedrag: function(inkomen) { return tarief.heffingsKorting.niet[0].bedrag - 0.04683 * (inkomen - tarief.heffingsKorting.niet[0].bovenGrens); } },
                { bedrag: 0 },
            ],
            in: false,
            voor: [
                { bovenGrens: 20142, bedrag: 1157 },
                { bovenGrens: 68507, bedrag: function(inkomen) { return tarief.heffingsKorting.voor[0].bedrag - 0.02389 * (inkomen - tarief.heffingsKorting.voor[0].bovenGrens); } },
                { bedrag: 0 },
            ],
        },
        ...
        arbeidsKorting: {
            niet: [
                { bovenGrens: 9468, percentage: 1.764 },
                { bovenGrens: 20450, bedrag: function(inkomen) { return 167 + 0.28064 * (inkomen - tarief.heffingsKorting.niet[0].bovenGrens); } },
                { bovenGrens: 33112, bedrag: 3249 },
                { bovenGrens: 123362, bedrag: function(inkomen) { return tarief.heffingsKorting.niet[2].bedrag - 0.036 * (inkomen - tarief.heffingsKorting.niet[2].bovenGrens); } },
                { bedrag: 0 },
            ],
            in: false,
            voor: [
                { bovenGrens: 9468, percentage: 0.901 },
                { bovenGrens: 20450, bedrag: function(inkomen) { return 86 + 0.14320 * (inkomen - tarief.heffingsKorting.voor[0].bovenGrens); } },
                { bovenGrens: 33112, bedrag: 1645 },
                { bovenGrens: 123362, bedrag: function(inkomen) { return tarief.heffingsKorting.voor[2].bedrag - 0.01837 * (inkomen - tarief.heffingsKorting.voor[2].bovenGrens); } },
                { bedrag: 0 },
            ],
        },
        ...
        loonstaatTemplate: (function () {
            var i= 1;
            /* @preserve
            <h1>Loonstaat 2018 <small>periode {{:periode}}, werknemer {{: werknemer.nummer }} / {{: inkomstenverhouding.nummer}}</small></h1>
